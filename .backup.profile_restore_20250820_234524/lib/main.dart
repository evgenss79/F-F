    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(icon: Icon(Icons.check_circle), label: 'Задачи'),
          NavigationDestination(icon: Icon(Icons.photo_library), label: 'Альбомы'),
          NavigationDestination(icon: Icon(Icons.person), label: 'Профиль'),
          NavigationDestination(icon: Icon(Icons.notifications), label: 'Уведомления'),
        ],
      ),
    );
  }
...
class _PageTemplate extends StatelessWidget {
  ...
  final IconData icon;
  const _PageTemplate({required this.title, required this.subtitle, required this.icon, super.key});
